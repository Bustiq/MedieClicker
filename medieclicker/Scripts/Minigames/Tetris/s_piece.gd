...
func setData():
	...
	pieceLength = [Vector2(0, 0), Vector2(-1, 0), Vector2(1, -1)]

func getHeight():
	return [Vector2(0, 0), Vector2(0, -1)]
func getLength():
	return [Vector2(0, 0), Vector2(-1, 0), Vector2(1, -1)]
func getSprite():
	return  Vector2(4, 0)
...
func rotTo90():	
	...
	pieceLength = [Vector2(0, 0), Vector2(1, 1)]
...
func rotTo180():
	pieceHeight = [Vector2(0, 0), Vector2(0, 1)]
	pieceLength = [Vector2(-1, 1), Vector2(0, 1), Vector2(1, 0)]
	if checkForAvailableRotations():
		...
		rotTo90()
func rotTo270():
	pieceHeight = [Vector2(-1, -1), Vector2(0, 0), Vector2(0, 1)]
