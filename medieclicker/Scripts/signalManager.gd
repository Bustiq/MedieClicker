...
signal on_upgrade_created(upgrade : UpgradeResource)
signal on_upgrade_unlocked(upgrade : UpgradeResource)
signal on_upgrade_purchased(upgrade : UpgradeResource)
signal on_upgrade_hovered(upgrade : UpgradeResource)
...
signal on_uicon_hover(upgrade : UpgradeResource)
signal on_uicon_unhover(upgrade : UpgradeResource)
